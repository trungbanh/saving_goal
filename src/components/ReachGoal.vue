<template>
    <div class="hover:bg-blue-gray-50 flex content-center cursor-pointer">
        <img class="my-auto mx-5" src="@/assets/chevron-left.svg" alt="left-icon" v-on:click="onClickLeftBtn">
    </div>
    ...
    <div class="hover:bg-blue-gray-50 flex content-center cursor-pointer">
        <img class="my-auto mx-5" src="@/assets/chevron-right.svg" alt="right-icon" v-on:click="onClickRightBtn">
    </div>
</template>
